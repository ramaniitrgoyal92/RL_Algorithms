...
if __name__=="__main__":
    ...
    cwd = os.getcwd()
    path_to_vdp = Path(cwd)/"Iterative_LQR (iLQR)/examples/vdp"
    ...
    ilqr = iLQR(run_vdp, state_dimension, control_dimension, alpha, horizon, init_state, final_state, Q, Q_final, R, nominal_init_stddev, n_sys_id_samples=500, pert_sys_id_sigma=1e-7)
